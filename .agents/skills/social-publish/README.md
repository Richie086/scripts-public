...
<details>
<summary>Show directory tree diagram for `social-publish`</summary>

```mermaid
graph TD
	root["social-publish"]:::root --> n1["README.md"]:::file-md
	root["social-publish"]:::root --> n2["SKILL.md"]:::file-md

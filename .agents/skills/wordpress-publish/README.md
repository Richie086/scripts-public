...
<details>
<summary>Show directory tree diagram for `wordpress-publish`</summary>

```mermaid
graph TD
	root["wordpress-publish"]:::root --> n1["README.md"]:::file-md
	root["wordpress-publish"]:::root --> n2["SKILL.md"]:::file-md

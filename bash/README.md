...
graph TD
	...
	root["bash"]:::root --> n9["setup_shared_dev_server.sh"]:::file-sh
	root["bash"]:::root --> n10["setup_ssh_key.md"]:::file-md
	root["bash"]:::root --> n11["virtualbox-install-guest-addtions-enable-bidrectional-clipboard.sh"]:::file-sh

...
graph TD
	...
	n4 --> n4_9[".pytest_cache<br>context_bootstrap.md<br>build.sh<br>implementation_plan.md<br>deploy.sh<br>walkthrough.md<br>pyproject.toml"]:::file-bundle
	n6 --> n6_1("dist"):::folder
	n5 --> n5_5["DEPLOYMENT.md<br>build.sh<br>terminus.py<br>deploy.sh"]:::file-bundle
	n7 --> n7_1("tests"):::folder
	n6 --> n6_2["export.py"]:::file-py
	n7 --> n7_3("src"):::folder
	n7 --> n7_7[".pytest_cache<br>context_bootstrap.md<br>build.sh<br>deploy.sh<br>pyproject.toml"]:::file-bundle
	n3_1 --> n3_1_1("stftpupload"):::folder
	n3_1 --> n3_1_2["README.md"]:::file-md
	n4_2 --> n4_2_1("v"):::folder
	n4_1 --> n4_1_1["test_api.py"]:::file-py
	...
	n4_3 --> n4_3_1["wedge_400_switch_api.egg-info"]:::file-other
	n6_1 --> n6_1_1("markdown"):::folder
	n5_1 --> n5_1_7["dev_workflow_guide.mp3<br>implementation_plan.md<br>generate_voiceover.py<br>dev_workflow_guide.md<br>walkthrough.md<br>master_prompt.md"]:::file-bundle
	n4_2 --> n4_2_1("v"):::folder
	n4_1 --> n4_1_1["test_crawler.py"]:::file-py
	...
	n4_3_1 --> n4_3_1_3("PKG-INFO"):::folder
	n4_3_2 --> n4_3_2_1("templates"):::folder
	n4_3_1 --> n4_3_1_5["dependency_links.txt<br>requires.txt<br>SOURCES.txt<br>top_level.txt"]:::file-text
	n4_3_2 --> n4_3_2_6["main.py<br>api.py<br>__init__.py<br>models.py<br>database.py"]:::file-py
	n6_1_1 --> n6_1_1_1("skills"):::folder
	n5_1_1 --> n5_1_1_2["terminus_tui_mockup.jpg<br>terminus_web_mockup.jpg"]:::file-image
	n4_2_1 --> n4_2_1_1("cache"):::folder
	n4_3_1 --> n4_3_1_1("templates"):::folder
	n6_1_1 --> n6_1_1_6["general_settings.md<br>global_skills.md<br>mcp_servers.md<br>workspace_rules.md<br>workspace_skills.md"]:::file-md
	n4_3_1 --> n4_3_1_3["main.py<br>__init__.py"]:::file-py
	n4_3_2 --> n4_3_2_3("PKG-INFO"):::folder
	n4_3_2 --> n4_3_2_5["dependency_links.txt<br>requires.txt<br>SOURCES.txt<br>top_level.txt"]:::file-text
	n4_2_1_1 --> n4_2_1_1_1("nodeids"):::folder
	n4_2_1_1 --> n4_2_1_1_2("lastfailed"):::folder
	n4_3_2_1 --> n4_3_2_1_1["index.html"]:::file-html
	n4_2_1_1 --> n4_2_1_1_1("nodeids"):::folder
	n4_2_1_1 --> n4_2_1_1_2("lastfailed"):::folder
	n6_1_1_1 --> n6_1_1_1_36["workspace_wordpress-taxonomy.md<br>global_building-data-apps.md<br>global_accidental-data-loss-prevention.md<br>global_gcloud-auth-verification.md<br>global_gcp-composer-troubleshooting.md<br>global_gcp-pipeline-resource-provisioning.md<br>global_managing-python-dependencies.md<br>... +29 more"]:::file-md
	n4_3_2_1 --> n4_3_2_1_1["index.html"]:::file-html
...
classDef file-image fill:#f3e8ff,stroke:#a855f7,stroke-width:1px,color:#581c87;

...
graph TD
	...
	n4 --> n4_10[".pytest_cache<br>context_bootstrap.md<br>build.sh<br>README.md<br>implementation_plan.md<br>deploy.sh<br>walkthrough.md<br>pyproject.toml"]:::file-bundle
	n6 --> n6_1("dist"):::folder
	...
	n4_1 --> n4_1_2["README.md<br>test_api.py"]:::file-bundle
	...
	n4_3_2 --> n4_3_2_7["README.md<br>main.py<br>api.py<br>__init__.py<br>models.py<br>database.py"]:::file-bundle

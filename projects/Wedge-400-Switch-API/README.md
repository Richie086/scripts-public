...
<details>
<summary>Show directory tree diagram for `Wedge-400-Switch-API`</summary>

```mermaid
graph TD
	root["Wedge-400-Switch-API"]:::root --> n1("tests"):::folder
	root["Wedge-400-Switch-API"]:::root --> n2[".pytest_cache"]:::file-other
	root["Wedge-400-Switch-API"]:::root --> n3("src"):::folder
	root["Wedge-400-Switch-API"]:::root --> n4["context_bootstrap.md"]:::file-md
	root["Wedge-400-Switch-API"]:::root --> n5["build.sh"]:::file-sh
	root["Wedge-400-Switch-API"]:::root --> n6["README.md"]:::file-md
	...
	n2_1 --> n2_1_1("cache"):::folder
	n2_1 --> n2_1_2["README.md"]:::file-md
	...
	n3_2_1 --> n3_2_1_2["README.md<br>index.html"]:::file-bundle

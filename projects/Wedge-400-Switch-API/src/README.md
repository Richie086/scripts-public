...
<details>
<summary>Show directory tree diagram for `src`</summary>

```mermaid
graph TD
	root["src"]:::root --> n1["wedge_400_switch_api.egg-info"]:::file-other
	root["src"]:::root --> n2("fastapi_starter"):::folder
	root["src"]:::root --> n3["README.md"]:::file-md

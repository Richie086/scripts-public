...
<details>
<summary>Show directory tree diagram for `tests`</summary>

```mermaid
graph TD
	root["tests"]:::root --> n1["README.md"]:::file-md
	root["tests"]:::root --> n2["test_api.py"]:::file-py
	root["tests"]:::root --> n3["test_auth.py"]:::file-py

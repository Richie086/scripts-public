...
- **Plugins:** run `bash scripts/apply-cursor-credit-savings.sh` (clears AWS plugin from all workspace scopes), or disable AWS Core / AI Agents on AWS in **Cursor Settings → Plugins**

...
| **Linux Bash** | [deploy-mailserver-debian.sh](file:///C:/Users/Richard%20Troiano/.gemini/antigravity/scratch/scripts-public/projects/deploy-mailserver-debian.sh) | Automates Postfix, Dovecot, OpenDKIM, and UFW firewall configuration on Debian 13. | **Root privileges**, Debian 13 |
...
| **Python** | [publish_wordpress_post.py](file:///C:/Users/Richard%20Troiano/.gemini/antigravity/scratch/scripts-public/python/publish_wordpress_post.py) | Publish a post to WordPress via Webhook (API-key-free post draft submission). | Python 3 |
...
| **Writeup** | [projects/deploy-mailserver-debian.md](file:///C:/Users/Richard%20Troiano/.gemini/antigravity/scratch/scripts-public/projects/deploy-mailserver-debian.md) | Technical configuration and rollback documentation for the Debian mail server script. | None |
| **Writeup** | [wordpress/deploy-mailserver-debian-blog.md](file:///C:/Users/Richard%20Troiano/.gemini/antigravity/scratch/scripts-public/wordpress/deploy-mailserver-debian-blog.md) | Catchy WordPress blog post detailing the development and warnings of the mail server deployment script. | None |
